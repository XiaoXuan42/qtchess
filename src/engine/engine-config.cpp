...
void EngineConfig::setName(const QString& name) { m_name = name; }

void EngineConfig::setCommand(const QString& command) { m_command = command; }

void EngineConfig::setWorkdir(const QString& workdir) { m_workdir = workdir; }

void EngineConfig::setArguments(const QString& arguments) {
    m_arguments = arguments;
}

QString EngineConfig::name() const { return m_name; }

QString EngineConfig::command() const { return m_command; }

QString EngineConfig::workdir() const { return m_workdir; }

QString EngineConfig::arguments() const { return m_arguments; }
...
QStringList EngineConfig::options() const { return m_options.keys(); }
...
bool EngineConfig::operator==(const EngineConfig& rhs) const {
    ...
    return m_name == rhs.m_name && m_command == rhs.m_command &&
           m_workdir == rhs.m_workdir && m_arguments == rhs.m_arguments &&
