...
public:
    ...
    enum Entry { MinValue, MaxValue, Default, Vars };
    ...
    static EngineOption spinbox(QString name, int minValue, int maxValue,
                                int defaultValue);
    ...
    static EngineOption combobox(QString name, QString defaultValue,
                                 QStringList values);
